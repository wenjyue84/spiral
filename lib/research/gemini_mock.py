        ...
        "weather": json.dumps(
            {
                ...
                "sources": ["https://weather.example.com/forecast", "https://meteo.example.org/data"],
                "key_points": [
        ...
        "finance": json.dumps(
            {
                ...
                "sources": ["https://finance.example.com/markets", "https://bloomberg.example.com/today"],
                "key_points": [
        ...
        "tech": json.dumps(
            {
                ...
                "sources": ["https://techcrunch.example.com/ai", "https://arstechnica.example.com/security"],
                "key_points": [
        ...
        "product": json.dumps(
            {
                ...
                "sources": ["https://producthunt.example.com/trending", "https://hacker-news.example.com/newest"],
                "key_points": [
        ...
        "legal": json.dumps(
            {
                ...
                "sources": ["https://law.example.com/ai-regulation", "https://privacy.example.gov/updates"],
                "key_points": [
    ...
    return json.dumps(
        {
            ...
            "key_points": ["Finding 1 relevant to query", "Finding 2 relevant to query"],
        }
    )
