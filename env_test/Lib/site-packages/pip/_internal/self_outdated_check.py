...
class UpgradePrompt:
    ...
    def __rich__(self) -> Group:
        ...
        return Group(
            Text(),
            Text.from_markup(
                f"{notice} A new release of pip is available: [red]{self.old}[reset] -> [green]{self.new}[reset]"
            ),
            Text.from_markup(f"{notice} To update, run: [green]{escape(pip_cmd)} install --upgrade pip"),
        )
