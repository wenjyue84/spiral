"""Security tests for Config API access control (US-1214).

Verifies that POST /api/config and GET /api/config enforce authentication
and that error responses never leak tokens, passwords, or secrets.
"""
...
_KEY = "test-spiral-api-key-us1214"
