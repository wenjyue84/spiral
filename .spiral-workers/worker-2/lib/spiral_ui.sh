#!/usr/bin/env bash
# lib/spiral_ui.sh — SPIRAL UI helpers: ANSI colors, banners, structured logging
#
# Functions: setup_colors, print_phase_banner, print_iter_summary_banner, log_msg
# Globals set: _USE_COLOR, _C_BLUE, _C_YELLOW, _C_GREEN, _C_RED, _C_CYAN, _C_RESET,
#              LOG_LEVELS, SPIRAL_LOG_LEVEL
#
